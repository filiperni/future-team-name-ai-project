...
async def root(posAx:float=0,posAy:float=0,posBx:float=0,posBy:float=0):
    ...
    wspolzedne,odleglosci = znajdz_linie((posAx,posAy),(posBx,posBy))
    ...
    return {"message": "Hello World","najblizsze_przystanki":wspolzedne,"odleglosci_do_przyst_a_b":odleglosci}